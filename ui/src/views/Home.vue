<template>
  <div class="max-w-md mx-auto space-y-8">
    <div class="retro-container">
      <h1 class="text-2xl font-bold text-center glow mb-8">
        🎾 Padel Friends
      </h1>
      
      <!-- Recent Groups -->
      <div v-if="savedGroups.length > 0" class="mb-8">
        <h2 class="text-xl pixel-text mb-4">🏆 Recent Groups</h2>
        <SavedGroupList
          :groups="savedGroups"
      ...
      <!-- Available Groups -->
      <div class="mb-8">
        <h2 class="text-xl pixel-text mb-4">🌟 Available Groups</h2>
        <GroupList
          :groups="groups"
          :loading="loading"
          :error="error"
